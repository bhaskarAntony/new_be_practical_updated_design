                ...
                <div className="course-single-text">
                    <div className="course-nav py-3">
                        <ul className='m-0 p-1'>
                            ...
                            <li><a href="/mern-fullstack">Digital Marketing</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="header-text">
                        <h1 className="course-header" data-aos="fade-up">Certification in  <br /><span className='main-text'>DigitalMarketing </span>Course</h1>
                        <div className="batch"> 

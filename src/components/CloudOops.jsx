                ...
                <div className="course-single-text">
                    <div className="course-nav py-3">
                        <ul className='m-0 p-1'>
                            ...
                            <li><a href="/mern-fullstack">Cloud Computing</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="header-text">
                        <h1 className="course-header" data-aos="fade-up">Certification in  <br /><span className='main-text'>Cloud Computing</span>COurse</h1>
                        <div className="batch"> 
